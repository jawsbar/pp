...
flags.DEFINE_integer("c_dim", 3, "The size of channel") # grayscale : 1 / color : 3
flags.DEFINE_boolean("is_train", False, "if the train") # train : true / test : false
flags.DEFINE_integer("scale", 3, "the size of scale factor for preprocessing input image")
flags.DEFINE_integer("stride", 21, "the size of stride") # train : 14 / test : 21
